...
<head>
	...
	$(function() {	
	    ...
	    $('#dataList').datagrid({ 
	        ...
	        fit: true,//自动大小 
	        method: "post",
	        url:"clazz_list?t="+new Date().getTime(),
	        idField:'id', 
	        ...
	        columns: [[  
                ...
                {field:'gradeId',title:'所属年级',width:200,
   		...
   		<form id="addForm" method="post">
	    	<table id="addTable" cellpadding="8">
				...
				<tr>
					<td>所属年级:</td>
					<td>
						<select id="add_gradeList" class="easyui-combobox" style="width: 200px; height: 30px;" name="gradeId" >
							<option value="">全部</option>
							<c:forEach items="${ gradeList}" var="grade">
								<option value="${grade.id}">${grade.name }</option>
							</c:forEach>
